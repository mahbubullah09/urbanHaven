...
const Footer = () => {
 ...
 <aside className="flex justify-center items-center flex-row">
  ...
  <nav className="flex justify-around items-center gap-4 md:place-self-center md:justify-self-end">
